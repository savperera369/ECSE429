...
Feature: Delete To-Do Category Association
	...
	Scenario Outline: Normal flow - Successfully delete an association
	...
	Scenario Outline: Alternate flow - Deleting an already removed association
		...
		And the response should indicate that there are no such associations

	Scenario Outline: Error flow - Invalid to-do ID
